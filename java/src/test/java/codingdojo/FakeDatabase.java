...
public class FakeDatabase implements CustomerDataLayer {
    ...
    private final HashMap<ExternalCustomer.ExternalCustomerId, Customer> customersByExternalId = new HashMap<>();
    ...
    @Override
    public Customer findByExternalId(ExternalCustomer.ExternalCustomerId externalId) {
